// Updated Dashboard.jsx with icons, tooltips, and loading skeleton
  ...
  const stats = [
    {
      ...
      icon: <DollarSign size={18} color="white" aria-label="Account Balance" title="Account Balance" />, bg: "#EA5455"
    },
    {
      label: "ACCOUNT TYPE",
      value: user?.accountType,
      icon: <MonitorSmartphone size={18} color="white" aria-label="Account Type" title="Account Type" />, bg: "#FF9F43"
    },
    {
      label: " TOTAL TRANSACTIONS",
      value: user?.totalTransactions,
      icon: <RotateCcw size={18} color="white" aria-label="Total Transactions" title="Total Transactions" />, bg: "#28C76F"
    },
    {
      label: "ACCOUNT NO.",
      value: user?.accountNumber,
      icon: <CreditCard size={18} color="white" aria-label="Account Number" title="Account Number" />, bg: "#7367F0"
    },
  ];
